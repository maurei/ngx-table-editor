...
export class ComponentLoader<T> {
	...
	to(container?: ElementRef): ComponentLoader<T> {
	...
	private _getContentRef(content: string | TemplateRef<any> | any, context?: any, initialState?: any): ContentRef {
		if (!content) {
		...
		if (content instanceof TemplateRef) {
			if (this._viewContainerRef) {
				const _viewRef = this._viewContainerRef.createEmbeddedView<TemplateRef<T>>(content, context);
